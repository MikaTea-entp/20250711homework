...
<head>
    ...
    body {
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        background: url("./pictures/Malibu.webp") center center / cover no-repeat fixed;
        color: #333;
        line-height: 1.6;
        margin: 0;
        padding: 2rem;
...
<body>
    ...
    <div class="section">
        <h1>ADeLE</h1>
        <p>— Art, Design & Logical thinking Education</p>
    ...
    <div class="section">
        ...
        <a href="./start.php" class="cta-button">Action Now →</a>
    </div>
